...
export default function Catalog() {
  ...
  const getProducts = useCallback(async () => {
    try {
      ...
      if (data) {
        ...
        const categoriesOptions = Array.from(categoryMap, ([label, id]) => ({
          id,
          label
        }))
  ...
  useEffect(() => {
    const filtered = allProducts.filter((product) => {
      ...
      const matchesCategory =
        selectedOptions.length === 0 || selectedOptions.includes(product.id)
  ...
  return (
    <div>
      ...
      <div className="flex flex-row rounded p-8 max-sm:flex-col">
        <div className="mr-8 mt-4 bg-white p-3">
              ...
              >
                ...
                <div className="mt-2 flex flex-col content-end">
                  ...
                  <div className="flex flex-row items-center">
                    ...
                    <p className="ml-2 text-primary"> 10% OFF</p>
                  </div>
                </div>
                <div
